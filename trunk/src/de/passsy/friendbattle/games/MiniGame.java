...
public abstract class MiniGame extends RelativeLayout{
    ...
    /**
     * true if the game has the state Correct
     * false if the game isn't correct at the moment
     */
     ...
     * @param isCorrect game is correct and can solved?
     */
     ...
     * gives and reduce points of the Players if they buzz
     * starts the next Game if the answer was correct
     * @param player
     */
    ...
    /**
     * gets fired after everything was loaded from the GameCycle
     * run super().start in method @Override
     * 
     */
    public void start(){
